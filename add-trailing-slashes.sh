...
# Script to add trailing slashes to all permalinks in use-cases documentation
...
find /Users/nrahal/@code_2025/products/quub/quub-exchange-docs/use-cases -type f \( -name "*-overview.md" -o -name "*-api-documentation.md" \) -exec sed -i '' 's|^\(permalink: .*[^/]\)$|\1/|g' {} \;
